...
class particle_grid_tree : public frantic::volumetrics::grid_tree_base<particle_grid_tree_leaf_data, PGT_SL> {
  ...
  public:
    ...
    /**
     * Inserts particles from a particle_array into our tree in PARALLEL.
     * @param  pa  The particle array containing the particles to insert.
     */
    void insert_particles_parallel( const frantic::particles::particle_array& pa );
