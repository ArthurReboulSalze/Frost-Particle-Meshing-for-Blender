...
// Forward declaration removed to avoid conflict with TBB headers
// namespace tbb {
// class filter;
// }
...
class prt2_writer {
  public:
     ...
     * of it.
     */
    class chunk_writer : public tbb_shim::filter, boost::noncopyable {
     ...
     * \param compressionScheme The compression method for the particle chunks in this file chunk.
     */
    void write_particle_chunks( boost::shared_ptr<tbb_shim::filter> chunkGenerator, boost::uint64_t totalParticleCount,
