 ...
 *
 *	@param	userData				Expected density_user_data - contains particle information,
 ...
 *
 *	@param	userData				Expected struct density_user_data. contains particle
 * information, point locations, and current densities
 *	@param	p						The particle to use for density calculation
 */
