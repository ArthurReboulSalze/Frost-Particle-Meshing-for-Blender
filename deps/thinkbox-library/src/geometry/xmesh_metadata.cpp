...
// xmesh_metadata::ptr_type xmesh_metadata::from_xml( tinyxml2::XMLDocument& doc, const frantic::tstring&
// pathForErrorMessage ) { 	xmesh_metadata::ptr_type result( new xmesh_metadata() ); 	result->from_xml( doc,
// pathForErrorMessage ); return result;
// }
