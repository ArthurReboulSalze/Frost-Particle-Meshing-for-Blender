...
#define Frost_RADIUSCHANNEL              _T("Radius")
#define Frost_RADIUSXYZCHANNEL           _T("RadiusXYZ")
#define Frost_COLORCHANNEL               _T("Color")
#define Frost_INTENSITYCHANNEL           _T("Intensity")
// clang-format on
