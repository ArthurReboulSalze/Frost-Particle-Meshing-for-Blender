...
class frost_parameters : public frost_parameter_interface {
  public:
    ...
    float get_plain_marching_cubes_radius_scale() const;
    void set_plain_marching_cubes_radius_scale( float plainMarchingCubesRadiusScale );
    float get_plain_marching_cubes_isovalue() const;
    void set_plain_marching_cubes_isovalue( float plainMarchingCubesIsovalue );
  ...
  private:
    ...
    float m_plainMarchingCubesRadiusScale;
    float m_plainMarchingCubesIsovalue;
