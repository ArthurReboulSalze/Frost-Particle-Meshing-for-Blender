...
frost_parameters::frost_parameters()
    ...
    , m_plainMarchingCubesRadiusScale( 1.5f )
    , m_plainMarchingCubesIsovalue( 0.5f )
...
float frost_parameters::get_plain_marching_cubes_radius_scale() const { return m_plainMarchingCubesRadiusScale; }
void frost_parameters::set_plain_marching_cubes_radius_scale( float plainMarchingCubesRadiusScale ) {
    m_plainMarchingCubesRadiusScale = plainMarchingCubesRadiusScale;
}
float frost_parameters::get_plain_marching_cubes_isovalue() const { return m_plainMarchingCubesIsovalue; }
void frost_parameters::set_plain_marching_cubes_isovalue( float plainMarchingCubesIsovalue ) {
    m_plainMarchingCubesIsovalue = plainMarchingCubesIsovalue;
}
